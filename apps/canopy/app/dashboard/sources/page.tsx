...
import { DashboardSources } from '../Sources';

export const dynamic = 'force-dynamic';

export default async function SourcesPage({ searchParams }: { searchParams: Promise<{ site?: string }> }) {
  ...
  return <DashboardSources siteId={current.id} />;
}